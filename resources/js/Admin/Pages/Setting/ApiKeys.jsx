...
function TextInput({ label, description, link, value, onChange, placeholder, mono = false }) {
    return (
...
function SecretInput({ label, description, link, value, onChange, placeholder, savedText }) {
...
// ── Kakao 섹션 ──────────────────────────────────────────────────────────────
function KakaoSection({ settings }) {
...
function SetupChecklist({ clientId, hasSecret, hasToken, callbackUrl }) {
...
// ── Google Blogger 섹션 ─────────────────────────────────────────────────────
function BloggerSection({ settings }) {
    const { data, setData, post, processing } = useForm({
