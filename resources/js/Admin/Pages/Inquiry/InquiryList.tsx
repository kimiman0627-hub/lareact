...
function DetailModal({ id, onClose }: DetailModalProps) {
    ...
    React.useEffect(() => {
        ajax.get(`/admin/inquiries/${id}`).then((data: any) => {
            setInquiry(data);
...
export default function InquiryList({ list, filters }: InquiryListProps) {
