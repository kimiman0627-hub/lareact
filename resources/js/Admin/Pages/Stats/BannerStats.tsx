...
function thisMonthStart(): string { return today().slice(0, 8) + "01"; }
...
const POSITION_LABEL: Record<string, string> = { MAIN_TOP: "메인상단", MAIN_BOTTOM: "메인하단", SIDE: "사이드", SIDE1: "사이드1", SIDE2: "사이드2" };
const TYPE_LABEL: Record<string, string>     = { IMAGE: "이미지", HTML: "HTML", IFRAME: "iframe", SCRIPT: "스크립트", VIDEO: "동영상" };
const STATUS_CLS: Record<string, string>     = { ACTIVE: "bg-green-100 text-green-700", INACTIVE: "bg-gray-100 text-gray-500" };
...
export default function BannerStats({ auth, bannerStats = [], summary = {}, series = [], from, to }: BannerStatsProps) {
