...
function StatCell({ value, colorCls = "text-slate-700" }: StatCellProps) {
...
interface CrawlLogListProps {
    logs: any;
    sources?: string[];
    params?: any;
}

export default function CrawlLogList({ logs, sources = [], params = {} }: CrawlLogListProps) {
