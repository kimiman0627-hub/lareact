...
export default function ScrapList({ list, total, params, categories }: ScrapListProps) {
                    ...
                    <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                                value={form.keyword}
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setForm({ ...form, keyword: e.target.value })}
                                placeholder="검색어 입력"
                            />
                        </div>
