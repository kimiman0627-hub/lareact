...
import type { Board, Post, SeoData } from "@/types";

interface LatestTickerProps {
    boards: (Board & { posts?: Post[] })[];
}

function LatestTicker({ boards }: LatestTickerProps) {
...
export default function MainIndex({ boards = [], popularPosts = [], seo = {} }: MainIndexProps) {
    const jsonLd = {
