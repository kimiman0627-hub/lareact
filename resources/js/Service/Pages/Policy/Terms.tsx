...
export default function Terms({ officerEmail = "" }: TermsProps) {
        ...
        <ServiceLayout sidebar={false}>
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm border border-gray-100 px-8 py-10">
                ...
                <Section title="제1조 (목적)">
                    <p>본 약관은 KRLived(이하 "서비스")가 제공하는 커뮤니티 서비스의 이용에 관한 조건 및 절차, 이용자와 서비스 운영자의 권리·의무·책임 사항을 규정함을 목적으로 합니다.</p>
                </Section>
                ...
                <Section title="제6조 (게시물 관리)">
                    <p>이용자가 게시한 게시물의 저작권은 해당 이용자에게 있습니다.</p>
                </Section>

                <Section title="제7조 (서비스 이용 제한)">
                    <p>운영자는 이용자가 본 약관을 위반한 경우 사전 통보 없이 서비스 이용을 제한하거나 계정을 정지·삭제할 수 있습니다.</p>
                </Section>

                <Section title="제8조 (서비스 제공 및 변경)">
                    <p>운영자는 서비스의 내용, 기능, 운영 시간 등을 변경하거나 중단할 수 있습니다.</p>
                </Section>
                ...
                <Section title="제10조 (분쟁 해결 및 준거법)">
                    <p>본 약관과 관련된 분쟁은 대한민국 법령을 준거법으로 하며, 관할 법원은 운영자 소재지 관할 법원으로 합니다.</p>
                </Section>

                <div className="bg-gray-50 rounded-lg px-4 py-3 mt-6">
                    <p className="text-sm font-semibold text-slate-700 mb-1">문의처</p>
                    {officerEmail && <p className="text-sm text-slate-600">이메일: <a href={`mailto:${officerEmail}`} className="text-blue-500 hover:underline">{officerEmail}</a></p>}
                    <p className="text-sm text-slate-600">문의: <a href="/inquiry?type=SUPPORT" className="text-blue-500 hover:underline">1:1 문의하기</a></p>
                </div>

                <p className="text-xs text-slate-400 text-right mt-6 pt-4 border-t border-gray-100">본 약관은 {updated}부터 시행됩니다.</p>
            </div>
        </ServiceLayout>
    );
}
