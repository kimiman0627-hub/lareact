    ...
    return (
        <ServiceLayout sidebar={false}>
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                ...
                <p className="text-7xl font-black text-slate-200 leading-none mb-4 select-none">{status}</p>
                <h1 className="text-xl font-bold text-slate-700 mb-2">{info.title}</h1>
                <p className="text-sm text-slate-400 mb-8 max-w-sm leading-relaxed">{info.description}</p>

                <div className="flex items-center gap-3">
                    <Link href="/" className="px-5 py-2.5 text-sm font-medium bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">
                        홈으로
                    </Link>
