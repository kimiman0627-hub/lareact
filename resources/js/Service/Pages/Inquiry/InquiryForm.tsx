...
export default function InquiryForm({ type: initialType }: InquiryFormProps) {
        ...
        <ServiceLayout>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">내용 <span className="text-red-500">*</span></label>
                        <textarea value={data.content} onChange={(e) => setData("content", e.target.value)}
                            placeholder="문의 내용을 자세히 입력해주세요." rows={7}
